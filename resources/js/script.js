   ...
   $(document).on('click' , '.form-events-filter-submit' , function(){
      ...
      $.ajax({
         ...
         success: function(data) {
            ...
            $.each(data, function () {
               $('.card-holder').append(` 
                  <div class="col-12 col-sm-6 col-lg-4 col-xl-4 col-xxl-3 my-3 d-flex solution-card-container" id="event-`+this.id+`">
                  <div class="solution_cards_box">
                     <div class="solution_card">
                        ...
                        <p class="card-date" data-value="`+ this.date +`"> 
                        `+ this.date + `
                        </p>
                           <div class="d-flex justify-content-between">
                                 <button type="button" class="read_more_btn card-clipboard">Copia data</button>
                                 <button class="btn delete_button eventItem text-light" data-eventid="`+this.id+`">Elimina</a>
                           </div>
                        </div>
                        </div>
                     </div>
